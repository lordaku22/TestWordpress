<div class="options_group">
    <p class="form-field">
       ...
       <img class="help_tip" data-tip="<?php _e('Color of the calendar background for the event.', 'fooevents-calendar'); ?>" src="<?php echo plugins_url(); ?>/woocommerce/assets/images/help.png" height="16" width="16" />
    </p>
</div>